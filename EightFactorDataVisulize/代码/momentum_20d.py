...
def main(_end_date,_last_week):
    ...
    save_dir = os.getcwd() + '/' + end_date + '/20日动量/'
    ...
    for a, b, c in zip(x, y, z):
        plt.text(a, b - 0.1, ('%.1f' % (c * 100)) + '%', ha='center', va='bottom', fontsize=15,
    ...
    return [["20日动量"], (diff_txt_list[0], diff_txt_list[1]), (diff_txt_list[2], diff_txt_list[3]),
