...
def main(_end_date,_last_week):
    ...
    save_dir = os.getcwd() + '/' + end_date + '/展期收益率/'
    ...
    plt.savefig(save_dir + title + '.png', bbox_inches='tight')
    plt.show()
    return [["展期收益率"], (diff_txt_list[0], diff_txt_list[1]), (diff_txt_list[2], diff_txt_list[3]),
